import{_ as t,c as e,o as a,U as i}from"./chunks/framework.8UM1mgsF.js";const m=JSON.parse('{"title":"git命令行备忘","description":"","frontmatter":{},"headers":[],"relativePath":"博客/git命令行备忘.md","filePath":"博客/git命令行备忘.md","lastUpdated":1704347211000}'),r={name:"博客/git命令行备忘.md"},o=i(`<h1 id="git命令行备忘" tabindex="-1">git命令行备忘 <a class="header-anchor" href="#git命令行备忘" aria-label="Permalink to &quot;git命令行备忘&quot;">​</a></h1><h3 id="查询命令" tabindex="-1">查询命令 <a class="header-anchor" href="#查询命令" aria-label="Permalink to &quot;查询命令&quot;">​</a></h3><pre><code>  1 git status           //查看修改过的文件命令
